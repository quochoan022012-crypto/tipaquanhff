...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        // Build Menu
        InfoRowView *r5 = [[InfoRowView alloc] initWithLeft:@"Build Menu" right:@"1.0.0"];
        [self addSubview:r5];
        [rowItems addObject:r5];
        
        // Owner
        InfoRowView *r6 = [[InfoRowView alloc] initWithLeft:@"Owner" right:@"@qhoanioss"];
        [self addSubview:r6];
...
- (void)viewDidLoad {
    ...
    _subTitleLabel.text = @"Telegram: @qhoanioss";
